...
KNOWN_SENSORS = [
    ...
    SensorType('p_reactiva_ind', 'r', 'Inductive_Reactive_Power', 'Inductive Reactive Power', 'VArL', SensorDeviceClass.POWER),
    SensorType('p_reactiva_cap', None, 'Capacitive_Reactive_Power', 'Capacitive Reactive Power', 'VArC', SensorDeviceClass.POWER),
    SensorType('p_aparent', 'p', 'Apparent_Power', 'Apparent Power', POWER_VOLT_AMPERE, SensorDeviceClass.POWER),
    ...
    SensorType('energia_reactiva_ind', 'o', 'Inductive_Reactive_Energy', 'Inductive Reactive Energy', 'VArLh', SensorDeviceClass.ENERGY),
    SensorType('energia_reactiva_cap', None, 'Capacitive_Reactive_Energy', 'Capacitive Reactive Energy', 'VArCh', SensorDeviceClass.ENERGY),
]
...
class WibeeeSensor(SensorEntity):
    ...
    def __init__(self, device, sensor_phase: str, sensor_type: SensorType, initial_value: StateType):
        ...
        self._attr_state_class = SensorStateClass.TOTAL_INCREASING if sensor_type.device_class is SensorDeviceClass.ENERGY else SensorStateClass.MEASUREMENT
