...
KNOWN_SENSORS = [
    ...
    SensorType('energia_reactiva_ind', 'o', 'Inductive_Reactive_Energy', 'Inductive Reactive Energy', 'var', SensorDeviceClass.REACTIVE_POWER),
    SensorType('energia_reactiva_cap', None, 'Capacitive_Reactive_Energy', 'Capacitive Reactive Energy', 'var', SensorDeviceClass.REACTIVE_POWER),
]
